...
public:
    ...
    void StepSimulation(RigidBody& rb, float dt, const World& world);
...
private:
    ...
    void ApplyGravity(RigidBody& rb, const World& world);
    ...
    void ResolveCollisions(RigidBody& rb, float dt, const World& world);
