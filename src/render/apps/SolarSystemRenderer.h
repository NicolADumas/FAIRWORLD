...
// Ape Operaia (Worker Renderer) dedicata in esclusiva al Sistema Solare e rivoluzioni di orbita
class SolarSystemRenderer : public AppRenderer {
public:
    SolarSystemRenderer() = default;
    ~SolarSystemRenderer() override = default;
